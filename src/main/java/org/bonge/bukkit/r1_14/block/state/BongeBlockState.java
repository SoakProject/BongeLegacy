...
import org.bonge.bukkit.r1_14.block.state.states.BongeChestBlockState;
import org.bonge.bukkit.r1_14.block.state.states.BongeSignBlockState;
...
public abstract class BongeBlockState<T extends BlockEntity> extends BongeWrapper<T> implements BlockState {
    ...
    protected org.spongepowered.api.world.Location<? extends org.spongepowered.api.world.World> position;
    ...
    public org.spongepowered.api.world.Location<? extends org.spongepowered.api.world.World> getPosition(){
    ...
    public World getWorld() {
        return new BongeWorld(this.position.getWorld());
    }
