package org.bonge.bukkit.r1_14.block;

import org.bonge.Bonge;
import org.bonge.bukkit.r1_14.block.data.BongeAbstractBlockData;
import org.bonge.bukkit.r1_14.block.state.BongeBasicBlockState;
...
public class BongeBlock extends BongeWrapper<Location<? extends World>> implements Block {

    public BongeBlock(Location<? extends World> value) {
        super(value);
    }
    ...
    public byte getLightLevel() {
        return (byte)this.spongeValue.getWorld().getLight(this.getX(), this.getY(), this.getZ());
    }

    @Override
    public byte getLightFromSky() {
        return (byte)this.spongeValue.getWorld().getLight(LightTypes.SKY, this.getX(), this.getY(), this.getZ());
    }

    @Override
    public byte getLightFromBlocks() {
        return (byte)this.spongeValue.getWorld().getLight(LightTypes.BLOCK, this.getX(), this.getY(), this.getZ());
    }
    ...
    public org.bukkit.Location getLocation() {
        return new BongeLocation(this.spongeValue.getWorld().getLocation(this.spongeValue.getBlockX(), this.spongeValue.getBlockY(), this.spongeValue.getBlockZ()));
    }
    ...
    public Chunk getChunk() {
        org.spongepowered.api.world.chunk.Chunk chunk = this.spongeValue.getWorld().getChunk(this.spongeValue.getChunkPosition());
    ...
    public boolean isBlockPowered() {
        return this.spongeValue.getBlock().get(Keys.IS_POWERED).get();
    }
    ...
    public int getBlockPower() {
        return this.spongeValue.getBlock().get(Keys.POWER).get();
    }
    ...
    public boolean breakNaturally() {
        World<?> world = this.spongeValue.getWorld();
    ...
    public boolean breakNaturally(@NotNull ItemStack tool) {
        ...
        Collection<GameProfile> profiles = Sponge.getServer().getGameProfileManager().getDefaultCache().getProfiles();
        if(profiles.isEmpty()){
            return false;
        }
    ...
    public boolean isPassable() {
        return !this.spongeValue.getBlock().get(Keys.IS_SOLID).orElse(true);
    }
    ...
    public String toString(){
        return "BongeBlock[X: " + this.getX() + " Y: " + this.getY() + " Z: " + this.getZ() + " World: " + this.getWorld().getName() + " State:" + this.spongeValue.getBlock().getKey().getValue() + "]";
    }
}
