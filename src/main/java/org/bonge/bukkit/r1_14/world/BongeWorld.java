...
public class BongeWorld extends BongeWrapper<org.spongepowered.api.world.World<? extends org.spongepowered.api.world.World>> implements World {
    ...
    public void setStorm(boolean b) {
        this.spongeValue.setWeather(b ? Weathers.THUNDER_STORM.get() : Weathers.CLEAR.get());
    }

    @Override
    public int getWeatherDuration() {
        return (int)this.spongeValue.getRunningWeatherDuration().toNanos();
    }

    @Override
    public void setWeatherDuration(int i) {
        this.spongeValue.setWeather(this.spongeValue.getWeather(), Duration.ofNanos(i));
    }
    ...
    public int getThunderDuration() {
        return (int)this.spongeValue.getRemainingWeatherDuration().toNanos();
    }

    @Override
    public void setThunderDuration(int i) {
        this.spongeValue.setWeather(Weathers.THUNDER_STORM.get(), Duration.ofNanos(i));
    }
