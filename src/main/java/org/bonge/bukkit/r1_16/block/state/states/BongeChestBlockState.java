package org.bonge.bukkit.r1_16.block.state.states;

import org.bonge.bukkit.r1_16.block.state.BongeContainerBlockState;
...
public class BongeChestBlockState extends BongeContainerBlockState<org.spongepowered.api.block.entity.carrier.chest.Chest> implements Chest {
    ...
    public boolean update(boolean force, boolean applyPhysics) {
        Optional<? extends BlockEntity> opTile = this.position.blockEntity();
        if (!force && !opTile.isPresent()) {
            ...
            opTile = this.position.blockEntity();
        }
