...
public abstract class BongeAbstractBlockData extends BongeWrapper<org.spongepowered.api.block.BlockState> implements IBongeBlockData {
    ...
    public @NotNull Material getMaterial() {
        try {
            return Bonge.getInstance().convert(Material.class, this.spongeValue.type());
        } catch (IOException e) {
    ...
    public boolean matches(BlockData data) {
        ...
        throw new NotImplementedException("BlockData.matches(BlockData) - Unknown how to match");
    }
