...
public abstract class BongeAbstractAnimal<T extends org.spongepowered.api.entity.living.animal.Animal> extends BongeAbstractLivingEntity<T> implements Animals {
    ...
    public void setTarget(LivingEntity target) {
        this.spongeValue.offer(Keys.TARGET_ENTITY, (((BongeAbstractEntity<?>)target).getSpongeValue()));
    }

    @Override
    public LivingEntity getTarget() {
        Optional<org.spongepowered.api.entity.Entity> opEntity = this.spongeValue.get(Keys.TARGET_ENTITY);
