...
public interface BongeChest extends IBongeBlockData, Chest, BongeDirectional, BongeWaterLogged {
    ...
    default Type getType() {
        ...
        if(chest.equals(ChestAttachmentTypes.NONE.get())){
            return Type.SINGLE;
        }
        throw new NotImplementedException("Unknown sponge type of '" + chest.getKey().getValue() +"'");
    }
    ...
    default void setType(@NotNull Type type) {
        ...
        switch (type){
            case SINGLE: type2 = ChestAttachmentTypes.NONE.get(); break;
